...
### 2026-09-16 Medical派生画像AI接続（開発・実送信前）
...
- 現在main/承認SHAは `0c6d99c6609b30ef61bdd2c085b1c6ad237edc0e` のまま。定期ON・旧日常OFF。
  本GoalのGoogle変更・Gemini実送信はまだ0。利用中プランの読取確認、Linux CI、Actionsでの実前処理、
  実送信/候補読戻し/replay、匿名化が成立しない場合の非公開確認・修正経路が残る。運用開始とは報告しない。
