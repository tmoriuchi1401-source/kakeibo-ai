...
INITIAL_STANDARD_ITEMS = (
    ...
    PayrollStandardItemRecord(standard_item_id="overtime_pay", standard_name="時間外手当",
                              section="earning", value_type="money"),
    PayrollStandardItemRecord(standard_item_id="night_work_pay", standard_name="深夜勤務",
                              section="earning", value_type="money"),
    ...
    PayrollStandardItemRecord(standard_item_id="nursing_care_insurance",
                              standard_name="介護保険",
                              section="deduction", value_type="money"),
    ...
    PayrollStandardItemRecord(standard_item_id="union_dues", standard_name="組合費",
                              section="deduction", value_type="money"),
    PayrollStandardItemRecord(standard_item_id="collective_savings",
                              standard_name="一斉預金",
                              section="deduction", value_type="money"),
    ...
    PayrollStandardItemRecord(standard_item_id="remuneration_amount",
                              standard_name="報酬月額",
                              section="reference", value_type="money"),
    PayrollStandardItemRecord(standard_item_id="standard_monthly_remuneration",
                              standard_name="標準報酬月額",
                              section="reference", value_type="money"),
...
INITIAL_ALIASES = (
    ...
    PayrollItemAliasRecord(alias_id="alias-nursing-care-insurance-fee",
                           raw_item_name="介護保険料",
                           standard_item_id="nursing_care_insurance"),
    ...
    PayrollItemAliasRecord(alias_id="alias-statutory-overtime-allowance",
                           raw_item_name="法定内残業手当", standard_item_id="overtime_pay"),
    PayrollItemAliasRecord(alias_id="alias-night-work-pay",
                           raw_item_name="深夜勤務", standard_item_id="night_work_pay"),
    PayrollItemAliasRecord(alias_id="alias-union-dues",
                           raw_item_name="組合費", standard_item_id="union_dues"),
    PayrollItemAliasRecord(alias_id="alias-collective-savings",
                           raw_item_name="一斉預金",
                           standard_item_id="collective_savings"),
    ...
    PayrollItemAliasRecord(alias_id="alias-standard-monthly-remuneration",
                           raw_item_name="標準報酬月額",
                           standard_item_id="standard_monthly_remuneration"),
